...
def extract_terms_and_ids_from_EFO(input_filename):
    """
    Extract terms and IDs from the provided EFO OWL ontology into a dictionary.
    ...
    for owl_class in tqdm(all_classes, desc="Extracting EFO Terms", total=len(all_classes)):
        # Extract the ID from rdf:about attribute
        EFO_id = owl_class.get('rdf:about')
        if EFO_id:
        ...
        if term_name and EFO_id:

            term_to_id[term_name.lower()] = EFO_id
...
if __name__ == "__main__":
    ...
    INPUT_FILENAME = "/home/stirunag/work/github/source_data/knowledge_base/EFO/EFO.owl"
    OUTPUT_PICKLE_FILENAME = "/home/stirunag/work/github/CAPITAL/normalisation/dictionary/EFO_terms.pkl"
    OUTPUT_LIST = "/home/stirunag/work/github/CAPITAL/normalisation/dictionary/EFO_list.txt"
    FAISS_INDEX_FILENAME = "/home/stirunag/work/github/CAPITAL/normalisation/dictionary/EFO_terms.index"
    MODEL_PATH = "/home/stirunag/work/github/CAPITAL/normalisation/en_floret_model"

    # Extract terms and IDs
    term_id_dict = extract_terms_and_ids_from_EFO(INPUT_FILENAME)
