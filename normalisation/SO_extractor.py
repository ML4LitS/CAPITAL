...
# Filenames
input_filename = "/home/stirunag/work/github/source_data/knowledge_base/so/so.owl"
output_pickle_filename = "/home/stirunag/work/github/ML_annotations/normalisation/dictionary/so_terms.pkl"
output_list = "/home/stirunag/work/github/source_data/training_data/so_list.txt"
faiss_index_filename = "/home/stirunag/work/github/ML_annotations/normalisation/dictionary/so_terms.index"

print("Loading ontology...")
so = Ontology(input_filename)
...
for term in tqdm(so.terms(), total=len(so.terms()), desc="Extracting Terms"):
    so_id = term.id
    term_name = term.name
    ...
    current_batch_ids.append(so_id)
