...
file_mapping = {
    ...
    'chemical': ('chebi_terms.index', 'chebi_terms.pkl'),
    'structure_element': ('so_terms.index', 'so_terms.pkl'),
    'residue_name': ('so_terms.index', 'so_terms.pkl'),
    'site': ('so_terms.index', 'so_terms.pkl'),
